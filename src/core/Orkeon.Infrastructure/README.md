...
**Orkeon.Infrastructure** provides the adapters: 14 LLM providers (OpenAI, Anthropic, Azure OpenAI, Ollama, Mistral, DeepSeek, Kimi, Qwen, TogetherAI, HuggingFace, Z.AI, Gemini, Grok, MiniMax), 6 memory stores (InMemory, Redis, SQLite, ChromaDB, Pinecone, LanceDB), the 6 orchestration strategies, the virtual file system, and the A2A channel.
