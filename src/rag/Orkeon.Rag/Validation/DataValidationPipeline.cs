...
public sealed partial class DataValidationPipeline
{
    ...
    public DataValidationPipeline(
        ...
        ILogger<DataValidationPipeline>? logger = null)
    {
        ...
        _logger = logger ?? NullLogger<DataValidationPipeline>.Instance;
    }
    ...
    [LoggerMessage(Level = LogLevel.Warning, Message = "Document {DocumentId} rejected by {Validator}: {Reason}")]
    private partial void LogDocumentRejectedBy(string documentId, string validator, string reason);

    [LoggerMessage(Level = LogLevel.Warning, Message = "Document {DocumentId} quarantined: {Reason}")]
    private partial void LogDocumentQuarantined(string documentId, string reason);

    [LoggerMessage(Level = LogLevel.Debug, Message = "Document {DocumentId} passed all validation checks")]
