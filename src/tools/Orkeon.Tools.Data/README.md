...
**Orkeon.Tools.Data** ships the data-manipulation agent tools: JSON, CSV, XML and PDF processing, database queries, email parsing and more.

## Install

```
dotnet add package Orkeon.Tools.Data --prerelease
```
