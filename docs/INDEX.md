...
| File | Description |
|------|-------------|
| [LLM providers](./architecture/llm-providers.md) | 11 providers (OpenAI, Anthropic, Azure, Groq, Ollama, etc.), adapters, factory |
...
| [Architecture Decision Records (ADR)](./adr/) | ADR-002 (Tools.Abstractions shared kernel), ADR-003 (Analysis shared kernels), ADR-004 (scripting naming twins), ADR-005 (heterogeneous Tools.* family) |
