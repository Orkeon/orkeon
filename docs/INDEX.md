...
| [Architecture Decision Records (ADR)](./adr/README.md) | ADR-002 (Tools.Abstractions shared kernel), ADR-003 (Analysis shared kernels), ADR-004 (scripting naming twins — superseded by ADR-007), ADR-005 (heterogeneous Tools.* family), ADR-006 (RAG subsystem `src/rag/`), ADR-007 (D3: `Orkeon.Cli.Commands.Scripting` rename), ADR-008 (virtual paths are the only currency agents are paid in) |
