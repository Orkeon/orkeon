...
- Un profil LLM (voir la [matrice de profils](../../appsettings/)) ; cet exemple a
...
> Référence des flags : [Exécuter votre premier exemple](../../../docs/fr/getting-started/run-your-first-example.md#chaque-flag-expliqué).
