...
| Fichier | Description |
|---------|-------------|
| [Fournisseurs LLM](./architecture/llm-providers.md) | 13 providers (OpenAI, Anthropic, Azure, Grok, Ollama, etc.), adaptateurs, factory, kit de campagnes sur API réelle |
