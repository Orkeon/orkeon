...
| Fichier | Description |
|---------|-------------|
| [Fournisseurs LLM](./architecture/llm-providers.md) | 16 providers (OpenAI, Anthropic, Azure, Grok, Ollama, les agrégateurs OpenRouter et Mammouth, etc.), adaptateurs, factory, kit de campagnes sur API réelle |
