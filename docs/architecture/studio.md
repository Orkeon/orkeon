...
novice card is where the shared « Allow a folder » picker still opens
...
name. After a fresh adoption the saved card says so («Nothing is frozen…») and
offers « Modify the team » and « Run the trial again » directly. Teams without a
session — imported, or whose session was deleted — keep « Modify » disabled,
