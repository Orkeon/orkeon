...
|---|---|---|
| **DeepSeek** (`deepseek-chat`, `deepseek-v4-flash`, `deepseek-v4-pro`) | ✅ | Wired via `DeepSeekLlmProvider.ApplyProviderSpecificOptions`. |
...
- Patch record: `Orkeon.Domain.Shared.ValueObjects.LlmConfigOverride`
