...
public class ProviderVisionPayloadTests
{
    ...
    [
        ...
        nameof(DeepSeekLlmProvider), nameof(GrokLlmProvider), nameof(MiniMaxLlmProvider),
        nameof(GeminiLlmProvider), nameof(OpenRouterLlmProvider), nameof(MammouthLlmProvider),
    ];
