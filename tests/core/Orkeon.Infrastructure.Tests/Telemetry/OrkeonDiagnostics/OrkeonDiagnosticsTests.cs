...
public class OrkeonDiagnosticsTests
{
    ...
    [InlineData(nameof(global::Orkeon.Infrastructure.Telemetry.OrkeonDiagnosticTags.AgentRole), "orkeon.agent.role")]
    [InlineData(nameof(global::Orkeon.Infrastructure.Telemetry.OrkeonDiagnosticTags.LlmProvider), "orkeon.llm.provider")]
    [InlineData(nameof(global::Orkeon.Infrastructure.Telemetry.OrkeonDiagnosticTags.LlmModel), "orkeon.llm.model")]
    [InlineData(nameof(global::Orkeon.Infrastructure.Telemetry.OrkeonDiagnosticTags.ToolName), "orkeon.tool.name")]
