namespace Orkeon.Cli.Scripting.Tests.Typings;

/// <summary>
/// Verifies that <c>Typings/orkeon-cli.d.ts</c> is shipped as an embedded resource of
/// <c>Orkeon.Cli.Scripting.dll</c> — the Phase 2 deliverable that backs Phase 5's
...
public sealed class EmbeddedTypingsTests
{
    ...
    {
        var asm = typeof(Orkeon.Cli.Scripting.Loading.ScriptCommandLoader).Assembly;
