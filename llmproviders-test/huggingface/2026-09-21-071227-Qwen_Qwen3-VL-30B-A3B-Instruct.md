...
| **Timestamp (UTC)** | 2026-09-21T07:12:29Z |
...
|---|---|---|---|---|
| M9 | Vision / multimodal | ✅ | image read: number 73 and red background both named | 2050 ms |
...
```
| 2026-09-21 | HuggingFace `Qwen/Qwen3-VL-30B-A3B-Instruct` | campaign `llmproviders-test` | M9 | ✅ | `llmproviders-test/huggingface/2026-09-21-071227-Qwen_Qwen3-VL-30B-A3B-Instruct.md` | Archived output |
```

Model table (§6.11):

```
| `Qwen/Qwen3-VL-30B-A3B-Instruct` | | | M9 | ✅ | 2026-09-21 | 1.0.0-rc.4 | campaign 2026-09-21-071227-Qwen_Qwen3-VL-30B-A3B-Instruct.md |
```
...
```json
{
  ...
  "commit": "fb00251a",
  "timestampUtc": "2026-09-21T07:12:29Z",
  "temperature": 0,
  "passed": 1,
  "failed": 0,
  "notApplicable": 0,
