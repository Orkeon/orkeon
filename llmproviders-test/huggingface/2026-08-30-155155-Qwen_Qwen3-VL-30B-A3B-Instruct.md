...
|---|---|---|---|---|
| M9 | Vision / multimodal | ✅ | image read: number 73 and red background both named | 1223 ms |
...
```
| 2026-08-30 | HuggingFace `Qwen/Qwen3-VL-30B-A3B-Instruct` | campagne `llmproviders-test` | M9 | ✅ | `llmproviders-test/huggingface/2026-08-30-155155-Qwen_Qwen3-VL-30B-A3B-Instruct.md` | Sortie archivée |
```

Tableau modèles (§6.11) :

```
| `Qwen/Qwen3-VL-30B-A3B-Instruct` | | | M9 | ✅ | 2026-08-30 | 1.0.0-rc.2 | campagne 2026-08-30-155155-Qwen_Qwen3-VL-30B-A3B-Instruct.md |
```
