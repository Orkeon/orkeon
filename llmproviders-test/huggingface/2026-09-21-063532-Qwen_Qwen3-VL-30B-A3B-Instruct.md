...
| **Timestamp (UTC)** | 2026-09-21T06:35:34Z |
...
|---|---|---|---|---|
| M9 | Vision / multimodal | ✅ | image read: number 73 and red background both named | 1592 ms |
...
```
| 2026-09-21 | HuggingFace `Qwen/Qwen3-VL-30B-A3B-Instruct` | campaign `llmproviders-test` | M9 | ✅ | `llmproviders-test/huggingface/2026-09-21-063532-Qwen_Qwen3-VL-30B-A3B-Instruct.md` | Archived output |
```

Model table (§6.11):

```
| `Qwen/Qwen3-VL-30B-A3B-Instruct` | | | M9 | ✅ | 2026-09-21 | 1.0.0-rc.3 | campaign 2026-09-21-063532-Qwen_Qwen3-VL-30B-A3B-Instruct.md |
```
...
```json
{
  ...
  "commit": "16660df6",
  "timestampUtc": "2026-09-21T06:35:34Z",
  "temperature": 0,
  "passed": 1,
  "failed": 0,
  "notApplicable": 0,
