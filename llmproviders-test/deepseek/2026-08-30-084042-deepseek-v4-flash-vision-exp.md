...
|---|---|---|---|---|
| M9 | Vision / multimodal | ✅ | image read: number 73 and red background both named | 2010 ms |
...
```
| 2026-08-30 | DeepSeek `deepseek-v4-flash-vision-exp` | campagne `llmproviders-test` | M9 | ✅ | `llmproviders-test/deepseek/2026-08-30-084042-deepseek-v4-flash-vision-exp.md` | Sortie archivée |
```

Tableau modèles (§6.7) :

```
| `deepseek-v4-flash-vision-exp` | | | M9 | ✅ | 2026-08-30 | 1.0.0-rc.2 | campagne 2026-08-30-084042-deepseek-v4-flash-vision-exp.md |
```
...
```json
{
  ...
  "commit": "db61e0dc",
  "timestampUtc": "2026-08-30T08:40:44Z",
  "temperature": 0,
  "passed": 1,
  "failed": 0,
  "notApplicable": 0,
